...
from modules.module4 import get_module as get_module4 # CGAN
...
for epoch in range(1, 1 + option.num_epochs):
    train_info = train(module, option.module, device, option.gen_latent_size, option.num_labels, loader, criterion, optimizerD, optimizerG, option.train_d_freq, option.train_g_freq, option.clip_params, option.weight_gp)
